...
public class Jantar extends JFrame {
	...
	public void SetInfo(int chave, int estado) {
		...
		if (chave == 0) {
			...
			if (estado == 0) {
				ImageIcon referencia = new ImageIcon("src\\Imagens\\arlequina00.png");		
				arist = referencia.getImage();
				
			} else if (estado == 1) {
				ImageIcon referencia = new ImageIcon("src\\Imagens\\arlequina11.png");		
				arist = referencia.getImage();
				
			} else if (estado == 2) {
				ImageIcon referencia = new ImageIcon("src\\Imagens\\arlequina22.png");		
				arist = referencia.getImage();				
			}
	...
	public Jantar() {
		setTitle("Jantar dos Filosofos -> Trabalho de Sistemas Operacionais");
		setIconImage(Toolkit.getDefaultToolkit().getImage(Jantar.class.getResource("/Imagens/Icon.png")));
			
		ImageIcon referencia = new ImageIcon("src\\Imagens\\fundo1.png");		
